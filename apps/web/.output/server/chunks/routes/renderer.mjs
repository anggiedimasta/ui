...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"A modern Vue 3 UI component library built with TypeScript and Tailwind CSS"}],"link":[],"style":[],"script":[],"noscript":[],"title":"@anggiedimasta/ui - Vue 3 UI Component Library"};
